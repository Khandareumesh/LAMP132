...
/**
 * @DI\Service("activity_timetable.handler.project_update", parent="activity_timetable.handler.project")
 *
 * @author Hessé <sylvain.carite@gmail.com>
 */
class ProjectUpdateHandler extends AbstractProjectHandler
{
    public function process(Request $request, Project $project)
    {
        $form = $this->formFactory->create('project', $project);
        $form->submit($request->request->all(), $request->getMethod()=='PUT');
